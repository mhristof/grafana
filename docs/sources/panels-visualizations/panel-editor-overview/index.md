...
- **More**: Access other panel actions.
  ...
  - **Create alert**: Open the alert rule configuration page in **Alerting**, where you can[create a Grafana-managed alert](ref:create-a-grafana-managed-alert) based on the panel queries.
