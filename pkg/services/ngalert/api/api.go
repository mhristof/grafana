...
type RuleAccessControlService interface {
	...
	HasAccessToRuleQuery(ctx context.Context, user identity.Requester, rule *models.AlertRule) (bool, error)
	AuthorizeAccessToRuleQuery(ctx context.Context, user identity.Requester, rule *models.AlertRule) error
}
