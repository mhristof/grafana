...
describe('AlertRule abilities', () => {
  ...
  it('works out correct silences permission on folder basis', async () => {
    ...
    await waitFor(() => expect(abilities.result.current).not.toBeUndefined());

    expect(abilities.result.current[AlertRuleAction.Silence]).toEqual([true, false]);
  });
